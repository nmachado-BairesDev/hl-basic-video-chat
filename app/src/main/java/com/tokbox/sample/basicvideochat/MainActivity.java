...
public class MainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    private Button mButtonMuteUnmute;
    ...
    private PublisherKit.AudioLevelListener audioLevelListener = new PublisherKit.AudioLevelListener(){
        @Override
        public void onAudioLevelUpdated(PublisherKit publisherKit, float v) {
            Log.d(TAG, "onAudioLevelUpdated: PublisherKit . float:  " + String.valueOf(v));
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonMuteUnmute = findViewById(R.id.button);
        mButtonMuteUnmute.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Log.d(TAG, "onClick: Mute/Unmute");
                if (publisher != null) {
                    Log.d(TAG, "get getPublishAudio? " +  publisher.getPublishAudio());
                    if (publisher.getPublishAudio()){
                        publisher.setPublishAudio(false);
                        mButtonMuteUnmute.setText("UnMute");
                        Log.d(TAG, ">>setPublishAudio to FALSE -?-> " +  publisher.getPublishAudio());
                    } else {
                        publisher.setPublishAudio(true);
                        mButtonMuteUnmute.setText("Mute");
                        Log.d(TAG, ">>setPublishAudio to TRUE -?-> " +  publisher.getPublishAudio());
                    }
                }
            }
        });
    ...
    public void onPermissionsDenied(int requestCode, List<String> perms) {
        if (requestCode == PERMISSIONS_REQUEST_CODE && perms.contains(Manifest.permission.CAMERA))
            finishWithMessage("onPermissionsDenied: " + requestCode + ": " + perms);
        else {
            Log.d(TAG, "onPermissionsDenied ... Continue...");
        }
    }
    ...
    private void requestPermissions() {
        ...
        String[] perms_no_audio = {Manifest.permission.INTERNET,
          Manifest.permission.CAMERA
        };

        if (EasyPermissions.hasPermissions(this, perms_no_audio)) {
